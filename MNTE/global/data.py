...
def get_paths(opt):
    """
    Returns paths to images and annotations for the given datasets.
    """
    name = opt.data_name
...
def get_transform(data_name, split_name, opt):
    ...
    t_list = []
    # raw images need to be resize
    if split_name == 'train':
        t_list = [transforms.RandomResizedCrop(opt.image_crop_size),
