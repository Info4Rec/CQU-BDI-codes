...
from models.encode_number import MergeNum, merge_pair_feature
...
class BottomUpFeaturesDataset:
    def __init__(self, root, json, features_path, split, ids=None, **kwargs):
        ...
        # merge number information
        self.merge_num = MergeNum(2048, weight_num=1.0)
    ...
    def __getitem__(self, index):
        ...
        # merge number information
        with torch.no_grad():
            img_feat, num_merge_feature = merge_pair_feature(img_feat, 0.9, self.merge_num)
