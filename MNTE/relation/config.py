...
class DefaultConfig(object):
    ...
    val_step = 2500
    test_step = 100000000
    logger_name = 'runs/f30k-relation'
    ...
    pre_extracted_features_root = "/data/data_yl/MNTE/f30k/images/features_36"
    # pre_extracted_features_root = "/data/data_yl/MNTE/coco/images/features_36"
